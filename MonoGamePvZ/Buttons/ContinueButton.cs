...
namespace PvZ.Buttons
{
    class ContinueButton : Buttons
    {

        public ContinueButton(Game1 game) : base(game)
        {
            Size = new Vector2(Game1.graphics.PreferredBackBufferWidth / 8, Game1.graphics.PreferredBackBufferHeight / 30);
            Position = new Vector2(Game1.graphics.PreferredBackBufferWidth / 3, Game1.graphics.PreferredBackBufferHeight / 6);
            LoadContent();
        ...
        protected override void LoadContent()
        {
            ...
            ButtonTexture = Game.Content.Load<Texture2D>("Продолжить");
