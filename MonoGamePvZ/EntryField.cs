...
namespace PvZ
{
    class EntryField : Microsoft.Xna.Framework.DrawableGameComponent
    {
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            spriteBatch.Draw(EntryBox, new Rectangle((int)Position.X - 20, (int)Position.Y - 50, 300, 150), Color.White);
            spriteBatch.DrawString(spriteFont, "Введите имя игрока", new Vector2(Position.X, Position.Y + 10), Color.White, 0, new Vector2(0, 0), 1.0f, SpriteEffects.None, 0f);
            spriteBatch.DrawString(spriteFont, Str, new Vector2(Position.X + 15, Position.Y + 50), Color.White, 0, new Vector2(0, 0), 1.0f, SpriteEffects.None, 0f);
            spriteBatch.End();
            base.Draw(gameTime);
        }
