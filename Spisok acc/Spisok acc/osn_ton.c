...
#include "Poisk_akk.h"
void osn_ton(struct muz_akk* h,struct muz_akk* p)
{
	struct muz_akk* tmp;
	int z;
	char osn_ton_akk[10];
	...
	printf("Введите основной тон желаемого аккорда: ");
	scanf("%s",osn_ton_akk);
	system("cls");
