...
namespace BigDataAnalyzer.Painting
{
    ...
    /// </summary>
    public class AIPaintingClassMethodDecisionTree : IAIPaintingMethod
    {
        int currentMethodID;
        int storageType;
        ...
        public AIPaintingClassMethodDecisionTree(int currentMethodID, int storageType, int assocArrayCapacity, object[] objectsToPaint, int[] indexesOfColumns)
        {
        ...
        public void PaintLearnResult()
        {
            ...
            DecisionTreeView decisionTreeView = (DecisionTreeView)objectsToPaint[0];
            ...
            try
            {
                ...
                surface = map.ToMatrix().InsertColumn(
                    ((DecisionTree)AIStorageList.getInstanse(assocArrayCapacity).GetAIStorageObject(currentMethodID)).Decide(map));
            }
            ...
            decisionTreeView.TreeSource = (DecisionTree)AIStorageList.getInstanse(assocArrayCapacity).GetAIStorageObject(currentMethodID);
